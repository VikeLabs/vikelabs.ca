    ...
    <DashboardWrapper title="Team Lead">
      <div>
        ...
        */}
        ...
        <li>Description</li>
        <li>
          Stack / Technologies - There's a preset list of technologies and
          colors, but the user can add a custom technology + color
        </li>
        ...
        <li>
          ...
          registered on the site - can choose whether to show pfp or not - add
          by github, with their preferred name and github username
        </li>
        <p>They can also see the info</p>
        <li>Order in /projects page</li>
        <li>
          Preview of what the project preview on /projects page looks like
        </li>
        <p>
          ...
          approval" button to alert admins of approval request and a "Save
          Draft" button to simply save.
        </p>
      </div>
    </DashboardWrapper>
  );

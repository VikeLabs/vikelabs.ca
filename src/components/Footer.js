              ...
              <div className="column is-4">
                <div className="social">
                  <a title="facebook" href="https://www.facebook.com/Vikelabs">
                    <FacebookOption style={iconStyle} alt="Facebook" />
                  </a>
                  <a title="instagram" href="https://instagram.com/vikelabs">
                    <Instagram style={iconStyle} alt="Instagram" />
                  </a>
                  <a
                    title="linkedin"
                    href="https://www.linkedin.com/company/vikelabs/"
                  >
                    <LinkedinOption style={iconStyle} alt="Linkedin" />
                  </a>
                </div>
                ...
                <div>
                  <section>
                    <p>
                      VikeLabs is based at the University of Victora. We
                      acknowledge with respect the Lekwungen peoples on whose
                      traditional territory the University of Victoria stands,
